...
class CreateCronjobsTable extends Migration
{
    public function up()
    {
        ...
        app(config('dashing.Models.Permission'))->createGroup('Cronjobs', ['create-cronjobs', 'read-cronjobs', 'update-cronjobs', 'delete-cronjobs'], 1);
        app(config('dashing.Models.Setting'))->create(['created_by' => 1, 'updated_by' => 1, 'key' => 'cronjob_status', 'value' => ['A' => 'Active', 'I' => 'Inactive']]);
