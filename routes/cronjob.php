...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'cronjob'], function () {
        ...
        Route::match(['post'], 'store', [config('dashing.Controllers.Cronjob'),'store'])->name('cronjob.store');
        Route::match(['get', 'head'], '{cronjob}/edit', [config('dashing.Controllers.Cronjob'),'edit'])->name('cronjob.edit');
        Route::match(['put', 'patch'], '{cronjob}/update', [config('dashing.Controllers.Cronjob'),'update'])->name('cronjob.update');
