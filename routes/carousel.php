...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'carousel'], function () {
        ...
        Route::match(['post'], 'store', [config('dashing.Controllers.Carousel'),'store'])->name('carousel.store');
        Route::match(['get', 'head'], '{model}/edit', [config('dashing.Controllers.Carousel'),'edit'])->name('carousel.edit');
        Route::match(['put', 'patch'], '{model}/update', [config('dashing.Controllers.Carousel'),'update'])->name('carousel.update');
