...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'page'], function () {
        ...
        Route::match(['post'], 'create', [config('dashing.Controllers.Page'),'store'])->name('page.store');
        Route::match(['get'], '{page}/edit', [config('dashing.Controllers.Page'),'edit'])->name('page.edit');
        Route::match(['put', 'patch'], '{page}/edit', [config('dashing.Controllers.Page'),'update'])->name('page.update');
