...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'versionizer'], function () {
        Route::match(['get'], '', [config('dashing.Controllers.Versionizer'),'index'])->name('versionizer');
        Route::match(['get'], '{versionizer}/read', [config('dashing.Controllers.Versionizer'),'show'])->name('versionizer.show');
