...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'nav'], function () {
        ...
        Route::match(['post'], 'create', [config('dashing.Controllers.Nav'),'store'])->name('nav.store');
        Route::match(['get'], '{nav}/edit', [config('dashing.Controllers.Nav'),'edit'])->name('nav.edit');
        Route::match(['put', 'patch'], '{nav}/edit', [config('dashing.Controllers.Nav'),'update'])->name('nav.update');
