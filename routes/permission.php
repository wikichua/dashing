...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'permission'], function () {
        ...
        Route::match(['post'], 'store', [config('dashing.Controllers.Permission'),'store'])->name('permission.store');
        Route::match(['get', 'head'], '{permission}/edit', [config('dashing.Controllers.Permission'),'edit'])->name('permission.edit');
        Route::match(['put', 'patch'], '{permission}/update', [config('dashing.Controllers.Permission'),'update'])->name('permission.update');
