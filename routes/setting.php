...
Route::group(['middleware' => ['web', 'auth_admin', 'can:access-admin-panel']], function () {
    Route::group(['prefix' => 'setting'], function () {
        ...
        Route::match(['post'], 'store', [config('dashing.Controllers.Setting'),'store'])->name('setting.store');
        Route::match(['get', 'head'], '{setting}/edit', [config('dashing.Controllers.Setting'),'edit'])->name('setting.edit');
        Route::match(['put', 'patch'], '{setting}/update', [config('dashing.Controllers.Setting'),'update'])->name('setting.update');
