<x-dashing::filter-card>
    ...
    <x-dashing::search-select-field name="group" id="group" label="Group" :options="app(config('dashing.Models.Permission'))->query()->groupby('group')->pluck('group','group')" multiple />
</x-dashing::filter-card>
