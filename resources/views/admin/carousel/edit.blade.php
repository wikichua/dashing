<x-dashing::app-layout>
    ...
    <x-dashing::content-card class="col-max">
        <div class="px-5">
            <x-dashing::form ajax="true" method="PATCH" action="{{ route('carousel.update',[$model->id]) }}">
                ...
                <x-dashing::select-field name="tags" id="tags" label="Tags"  :options="settings('carousel_tags')" :selected="$model->tags ?? []"/>
