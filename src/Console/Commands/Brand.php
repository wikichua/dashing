...
{
    protected $signature = 'dashing:make:brand {brand} {--domain=} {--force}';
    ...
    public function __construct()
    {
        ...
        $this->stub_path = config('dashing.stubs.path').'/brand';
    }

    public function handle()
    {
        $this->brand = \Str::studly($this->argument('brand'));
        if (strtolower($this->brand) == 'dashing') {
    ...
    protected function seed()
    {
        ...
        $filename = "dashing{$this->brand}BrandSeed.php";
