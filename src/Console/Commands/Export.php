...
{
    protected $signature = 'dashing:export {model} {path?} {--brand=} {--deleteAfterZip=yes}';
    ...
    private function setDefaultProperties()
    {
        ...
        $this->config_file = config_path('dashing/'.$this->model.'Config.php');
        ...
        $this->web_route_file = base_path('routes/dashing/'.$this->model_variable.'Routes.php');
        $this->api_route_file = base_path('routes/dashing/api/'.$this->model_variable.'Routes.php');
        $this->db_file = "dashing{$this->model}Table.php";
        $this->db_path = database_path('migrations');
        $menu = $this->file->get(resource_path('views/vendor/dashing/components/admin-menu.blade.php'));
    ...
    private function setBrandProperties()
    {
        ...
        $this->config_file = $this->base_path.'/config/dashing/'.$this->model.'Config.php';
        ...
        $this->web_route_file = $this->base_path.'/routes/dashing/'.$this->model_variable.'Routes.php';
        $this->api_route_file = $this->base_path.'/routes/dashing/api/'.$this->model_variable.'Routes.php';
        $this->db_file = "dashing{$this->model}Table.php";
    ...
    private function zip()
    {
        ...
        if (true !== $ret) {
            ...
            $this->info($this->path.'.zip has been created. To import, please run php artisan dashing:import '.$this->path.'.zip');
        }
    }
}
