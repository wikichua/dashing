...
class CronjobController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $models = app(config('dashing.Models.Cronjob'))->query()
                ->checkBrand()
    ...
    public function store(Request $request)
    {
        ...
        $model = app(config('dashing.Models.Cronjob'))->create($request->all());
    ...
    public function show($id)
    {
        ...
        $model = app(config('dashing.Models.Cronjob'))->query()->findOrFail($id);
