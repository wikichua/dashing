...
class CarouselController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $models = app(config('dashing.Models.Carousel'))->query()
                ->with('brand')
                ->checkBrand()
    ...
    public function store(Request $request)
    {
        ...
        $model = app(config('dashing.Models.Carousel'))->query()->create($request->input());
    ...
    public function show($id)
    {
        ...
        $model = app(config('dashing.Models.Carousel'))->query()->findOrFail($id);
    ...
    public function orderableUpdate(Request $request, $orderable = '', $brand_id = '')
    {
        ...
        $models = app(config('dashing.Models.Carousel'))->query()->select('id')
