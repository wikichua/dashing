...
class PusherController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $models = app(config('dashing.Models.Pusher'))->query()
                ->with('brand')
                ->checkBrand()
    ...
    public function store(Request $request)
    {
        ...
        $model = app(config('dashing.Models.Pusher'))->create($request->all());
    ...
    public function show($id)
    {
        ...
        $model = app(config('dashing.Models.Pusher'))->query()->findOrFail($id);
