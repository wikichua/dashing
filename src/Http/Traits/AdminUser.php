...
namespace Wikichua\Dashing\Http\Traits;

use Illuminate\Support\Facades\Cache;
use Illuminate\Auth\Notifications\ResetPassword;
use Wikichua\Dashing\Notifications\ResetAdminPassword;
...
trait AdminUser
{
    ...
    {
        return $this->belongsToMany(config('dashing.Models.Role'));
    }

    // permissions relationship
    public function permissions()
    {
        return $this->belongsToMany(config('dashing.Models.Permission'));
    }

    // activity logs relationship
    public function activity_logs()
    {
        return $this->hasMany(config('dashing.Models.Audit'));
    }
    ...
    {
        $permissions = [];
        foreach (app(config('dashing.Models.Permission'))->all() as $permission) {
